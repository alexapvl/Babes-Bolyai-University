...
bool Service::removeMovieByPosition(int positionOfMovie) {
  ...
  */
  if (!this->repository.validatePosition(positionOfMovie)) return false;
...
bool Service::updateMovie(int position, Movie movie) {
  ...
  */
  if (!this->repository.validatePosition(position)) return false;
...
DynamicVector<int> Service::getWatchList() const {
  /*
...
Movie Service::getMovieByPosition(int position) const {
  ...
  If the position is invalid, throws a runtime error
  */
...
DynamicVector<int> Service::getMoviesByGenre(const std::string& genre) {
  /*
...
void Service::incrementLikes(int index) {
  ...
  If the position is invalid, throws a runtime error
  */
  if (!this->repository.validatePosition(index))
    throw std::runtime_error("Invalid position");
...
void Service::generateRandomMovies() {
  ...
  */
  Movie entryMovie1 = Movie("The Godfather", "Crime", 1972, rand() % 100 + 1,
                            "https://www.youtube.com/watch?v=sY1S34973zA");
  Movie entryMovie2 =
      Movie("Schindler's List", "Biography", 1993, rand() % 100 + 1,
            "https://www.youtube.com/watch?v=gG22XNhtnoY");
  Movie entryMovie3 = Movie("2012", "Action", 2009, rand() % 100 + 1,
                            "https://www.youtube.com/watch?v=sFXGrTng0gQ");
  Movie entryMovie4 =
      Movie("The Shawshank Redemption", "Drama", 1994, rand() % 100 + 1,
            "https://www.youtube.com/watch?v=6hB3S9bIaco");
  Movie entryMovie5 = Movie("The Dark Knight", "Action", 2008, rand() % 100 + 1,
                            "https://www.youtube.com/watch?v=EXeTwQWrcwY");
  Movie entryMovie6 =
      Movie("The Lord of the Rings: The Return of the King", "Adventure", 2003,
            rand() % 100 + 1, "https://www.youtube.com/watch?v=r5X-hFf6Bwo");
  Movie entryMovie7 =
      Movie("The Godfather: Part II", "Crime", 1974, rand() % 100 + 1,
            "https://www.youtube.com/watch?v=9O1Iy9od7-A");
  Movie entryMovie8 = Movie("The Lord of the Rings: The Fellowship of the Ring",
                            "Adventure", 2001, rand() % 100 + 1,
                            "https://www.youtube.com/watch?v=V75dMMIW2B4");
  Movie entryMovie9 = Movie("Pulp Fiction", "Crime", 1994, rand() % 100 + 1,
                            "https://www.youtube.com/watch?v=s7EdQ4FqbhY");
  Movie entryMovie10 =
      Movie("The Good, the Bad and the Ugly", "Western", 1966, rand() % 100 + 1,
            "https://www.youtube.com/watch?v=WCN5JJY_wiA");
  Movie entryMovie11 =
      Movie("The Lord of the Rings: The Two Towers", "Adventure", 2002,
            rand() % 100 + 1, "https://www.youtube.com/watch?v=LbfMDwc4azU");
  Movie entryMovie12 = Movie("Inception", "Action", 2010, rand() % 100 + 1,
                             "https://www.youtube.com/watch?v=YoHD9XEInc0");
  Movie entryMovie13 = Movie("Fight Club", "Drama", 1999, rand() % 100 + 1,
                             "https://www.youtube.com/watch?v=SUXWAEX2jlg");
  Movie entryMovie14 = Movie("Forrest Gump", "Drama", 1994, rand() % 100 + 1,
                             "https://www.youtube.com/watch?v=bLvqoHBptjg");
  Movie entryMovie15 =
      Movie("Star Wars: Episode V - The Empire Strikes Back", "Action", 1980,
            rand() % 100 + 1, "https://www.youtube.com/watch?v=JNwNXF9Y6kY");
