...
void FileRepository::loadMoviesIntoRepository() {
  ...
  while (true) {
    try {
      ...
      Repository::addMovie(readMovieFromTextFile);
...
CSVRepository::CSVRepository(const std::string& fileName, const std::string& fileNameWatchList, const int& repoType) : FileRepository(fileName, fileNameWatchList, repoType) {}
...
// HTML Repository
HTMLRepository::HTMLRepository(const std::string& fileName, const std::string& fileNameWatchList, const int& repoType) : FileRepository(fileName, fileNameWatchList, repoType) {}
