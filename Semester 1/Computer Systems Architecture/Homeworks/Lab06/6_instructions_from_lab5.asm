...
segment code use32 class=code
	start:
		...
		mov esi, 0; index in source => string of words: s (this index will be incremented with 2 at a time because we have words)
		mov edi, 0; index in source => sting of bytes: d (this index will be incremented with 1 at a time because we have bytes)
		...
		Repeat:
			...
			skip_positive:
				;we need to put the value of bh in [d + edi]
				mov [d + edi], bh; number of zeros/ones that were numbered
				add esi, 2
				inc edi
